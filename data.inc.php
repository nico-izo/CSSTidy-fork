 ...
 * @version 1.0
 */
$GLOBALS['csstidy']['units'] = array('in','cm','mm','pt','pc','px','rem','em','%','ex','ch','vw','vh','vm','deg','grad','rad','turn','ms','s','khz','hz','fr','gr');
...
$GLOBALS['csstidy']['shorthands']['border-radius'] = array('border-top-left-radius', 'border-top-right-radius', 'border-bottom-right-radius', 'border-bottom-left-radius');
...
$GLOBALS['csstidy']['all_properties']['size'] = 'CSS1.0,CSS2.0'; // WTF
...
$GLOBALS['csstidy']['all_properties']['z-index'] = 'CSS1.0,CSS2.0,CSS2.1,CSS3.0';
/* Speech */
/* TODO: CSS3 */
